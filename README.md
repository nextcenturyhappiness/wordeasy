...
- The canonical authoring dataset contains 60 Research cards and a reshaped Medical catalog (chart/class vocabulary plus 词根构词, with hard specialty cards deactivated). It is not shipped in the initial browser bundle.
