...
每张卡必填字段完整，target text 出现在 context 中。Research / Medical 的 collocations 非空；必备医学英语 collocations 必须为空，`usage_note` 可为空，有词根词缀故事时须为中文课堂构词。云端 daily snapshot 解析不得因空 `usage_note` 拒绝必备医学英语卡片。
