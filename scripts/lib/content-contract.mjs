...
export const CANONICAL_MEDICAL_TOTAL = CANONICAL_MEDICAL_ACTIVE_TOTAL + CANONICAL_MEDICAL_INACTIVE_TOTAL;
export const CANONICAL_ACTIVE_CARD_TOTAL = CANONICAL_RESEARCH_TOTAL + CANONICAL_MEDICAL_ACTIVE_TOTAL;
