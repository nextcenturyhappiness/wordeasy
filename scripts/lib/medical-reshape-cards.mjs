export const MEDICAL_REPLACEMENT_CARDS = [
  ...
  },
  {
    ...
    meaning_zh: "气道；呼吸道",
    usage_note: "强调空气进出肺的通路是否通畅。喘气本身先写 dyspnea，只有通路受阻或要保护通气时才写 airway。",
    context_sentence: "The nurse kept the airway open while the patient was still drowsy.",
    target_text: "airway",
    plain_english_paraphrase: "The nurse made sure air could still move in and out while the patient was sleepy.",
  ...
  },
  {
    ...
    meaning_zh: "缺氧",
    usage_note: "组织缺氧才能写。血氧读数低常先写 hypoxemia；没有氧供或灌注证据时，不要随口升级成 hypoxia。",
    context_sentence: "Supplemental oxygen was started after signs of hypoxia appeared during walking.",
    target_text: "hypoxia",
    plain_english_paraphrase: "Extra oxygen was given when the patient started to look short of oxygen while walking.",
  ...
  },
  {
    ...
    meaning_zh: "脉搏",
    usage_note: "查体摸到的动脉搏动或生命体征里的脉率。心电图上的心率可以不同，不要把摸不到的电活动直接写成 pulse。",
    context_sentence: "Her pulse was regular at 88 beats per minute.",
    target_text: "pulse",
    plain_english_paraphrase: "The beating felt at the wrist came at a steady 88 times each minute.",
  ...
  },
  {
    ...
    meaning_zh: "感染",
    usage_note: "有病原体侵入并造成损害才写。单纯发热或定植还不到 infection；脓毒症是更重的全身反应。",
    context_sentence: "Wound infection was suspected when redness and pus appeared on day three.",
    target_text: "infection",
    plain_english_paraphrase: "Doctors thought germs had entered the wound after it turned red and started to drain pus.",
  ...
  },
  {
    ...
    meaning_zh: "排除（某一诊断）",
    usage_note: "检查或推理已经足够否定该病才写。还在怀疑时写 consider 或 cannot exclude，不要提前 rule out。",
    context_sentence: "A chest radiograph was obtained to rule out pneumonia.",
    target_text: "rule out",
    plain_english_paraphrase: "A chest X-ray was taken so doctors could see whether pneumonia could be excluded.",
  ...
  },
  {
    ...
    target_text: "culture",
    plain_english_paraphrase: "A blood sample was taken to grow any germs before antibiotics were started.",
  ...
  },
  {
    ...
    usage_note: "化验值高于参考范围时用。还在正常高限内不要写；具体数字比单独一个 elevated 更清楚。",
  ...
  },
  {
    ...
    target_text: "dose",
    plain_english_paraphrase: "The night-time amount of acetaminophen was skipped after liver tests went up.",
  ...
  },
  {
    ...
    meaning_zh: "过敏",
    usage_note: "真正的免疫反应才写 allergy。普通副作用或胃肠不适先写 intolerance，不要把所有“不能吃”都写成过敏。",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Feeling sick to the stomach often happens with this antibiotic even when it is working.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The surgical cut on the abdomen looked clean and was not leaking fluid.",
  ...
  },
  {
    ...
    usage_note: "有计划的诊疗操作。吃药或普通查体不要写成 procedure；具体手术名更清楚时优先写手术名。",
    context_sentence: "The procedure was explained, and written consent was obtained.",
    target_text: "procedure",
    plain_english_paraphrase: "Staff described the planned intervention and the patient signed a consent form.",
  ...
  },
  {
    ...
    usage_note: "正式结束本次住院或就诊。伤口渗液那个 discharge 是另一义；转科或请假回家还不是 discharged。",
    context_sentence: "He was discharged home with oral antibiotics and a wound check in two days.",
    target_text: "discharged",
    plain_english_paraphrase: "He was allowed to leave the hospital with antibiotic pills and a planned wound visit.",
...
export const MEDICAL_MORPHOLOGY_CARDS = [
  ...
  },
  {
    ...
    plain_english_paraphrase: "Sudden liver inflammation may show yellow skin, dark urine, and tiredness.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Pain high in the belly after drinking a lot made stomach-lining inflammation likely.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Both knees felt stiff in the morning in a way that fit joint inflammation.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Odd bruising and tiredness led doctors to look for a white-cell cancer.",
  ...
  },
  {
    ...
    target_text: "anemia",
    plain_english_paraphrase: "Blood tests showed too little hemoglobin because the body lacked iron.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Blood sugar was still too high in the morning after the night insulin change.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The patient stopped sweating and thinking unclearly after low blood sugar was treated.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "High blood pressure that had lasted for years was treated with a daily pill.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Getting up fast made the patient dizzy because blood pressure dropped on standing.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The heart beat too fast in a normal rhythm while the patient had fever and lost fluid.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Night heart monitoring found periods when the pulse slowed to 42 beats a minute.",
  ...
  },
  {
    ...
    context_sentence: "Proximal weakness and a high creatine kinase raised concern for drug-induced myopathy.",
  ...
  },
  {
    ...
    meaning_en: "porous, low-density bone that fractures easily (osteo- bone + -porosis porous condition)",
    meaning_zh: "骨质疏松",
    usage_note:
    ...
    plain_english_paraphrase: "A crushed spine bone was blamed on bones that had become thin and fragile.",
    sentence_translation_zh: "椎体压缩骨折被归因于骨质疏松。",
    collocations: ["postmenopausal osteoporosis", "severe osteoporosis", "osteoporosis-related fracture"]
  },
  {
  ...
  },
  {
    ...
    category: "morphology",
    context_genre: "medical_record",
    meaning_en: "active bleeding, especially a clinically important loss of blood (hemat-/hem- blood + -rrhage bursting forth)",
    meaning_zh: "出血",
    usage_note:
      "hem- 是血，-rrhage 是涌出。词根强调血涌出来。少量渗血先写 bleeding，不能只靠构词升级成大出血。",
    context_sentence: "Gastrointestinal hemorrhage presented as black stools and a falling hemoglobin.",
    target_text: "hemorrhage",
    plain_english_paraphrase: "Bleeding in the gut showed up as black stool and a dropping blood count.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The insulin shot went into the fat just under the skin before breakfast.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The scan found one new growth in the lung that still needed a tissue sample.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "The tissue sample showed a cancer that started from the lung lining cells.",
  ...
  },
  {
    ...
    target_text: "biopsy",
    plain_english_paraphrase: "A small piece of skin was taken so the lab could confirm what the rash was.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Starting treatment early made a better recovery from pneumonia more likely.",
  ...
  },
  {
    ...
    plain_english_paraphrase: "Doctors currently named the illness as a kidney infection while waiting for the urine test.",
  ...
  },
  {
    ...
    category: "morphology",
    context_genre: "clinical_guideline",
    meaning_en: "a drug used against living microbes (anti- against + bio- life + -tic relating to)",
    meaning_zh: "抗生素",
    usage_note:
    ...
    plain_english_paraphrase: "An antimicrobial drug was begun once blood had been taken to grow any germs.",
  ...
  },
  {
    ...
    category: "morphology",
    context_genre: "medical_record",
    meaning_en: "a medicine that lowers fever (anti- against + pyr- fire/fever + -etic relating to)",
    meaning_zh: "退热药",
    usage_note:
    ...
    plain_english_paraphrase: "A fever-lowering medicine was given after the temperature rose to 39.2 °C.",
