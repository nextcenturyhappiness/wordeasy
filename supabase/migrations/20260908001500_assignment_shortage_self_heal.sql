-- Replace empty shortage assignment sets when the catalog can now fill the quota.
-- Additive replacement of ensure_daily_assignment_v1_unlocked; ready sets stay frozen.
