-- Add 必备医学英语 daily assignment: 10 new cards from one category.
-- Additive replacement of ensure_daily_assignment_v1_unlocked; Research 5+2+3 and Medical 7+3 unchanged.
